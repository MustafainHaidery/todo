...
const NewTodo = ({alert, alertValue}: {alertValue:number, alert: (data: number) => void}) => {
    ...
    return (
        <>
            ...
            <div className={`fixed inset-0 w-full h-full z-10 bg-gray-100 bg-opacity-75 ${show ? 'flex' : 'hidden'} items-center justify-center`}>
                <div className="bg-blue-950 border border-gray-700 md:border-transparent  rounded-lg p-4 w-full m-2 md:m-0 md:w-1/3 z-10" >
